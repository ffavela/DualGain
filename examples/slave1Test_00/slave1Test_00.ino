...
// 22 giu
// quando cambi il gain con G1gainSetup() AUTOMATICAMENTE si deve cambiare G1Vref_pin per mantenere G1_Vos vicino a quello impostato.
// Pertanto decido di aggiungere un analogWrite(Vfre_pin, .........) all'interno della funzione G1gainSetup.
// INOLTRE ------> decido di inserire le seguenti funzioni:
// 1. G1_VosSetup()
// 2. VclampPosSetupup()
// 3. VclampNegSet()

// 17 giu
// ipotizzo una struttura a microprocessore dove il uC sulla scheda a 32 ch esegue soltanto
// comandi a basso livello ( tutti i dati sono a 8 bit così come è il uC)
// il uC che sarà sul backplane terrà conto di istruzioni a più alto livello che contengono
// anche informazioni sul tipo di dato a 16bit, ad esempio.

// 11 giu
// ottimizzate nomenclature
// definizione della funzione G1code()
